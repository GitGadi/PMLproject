...
Rpart significantly under performed with an accuracy of only `r c1$overall[1]` on the test set,  rpart2, rFerns resulted in good accuracy with similar results in both sets (rpart2 `r s2$overall[1]` and `r c2$overall[1]`in the training and testing sets correspondingly  and  rFerns `r s3$overall[1]` and `r c3$overall[1]`in the training and testing sets correspondingly),  C5.0 results were superior to all the other algorithms with accuracy of  `r c3$overall[1]` in the testing set
